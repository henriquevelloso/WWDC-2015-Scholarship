...
class ProfessionalViewController:  UIViewController , UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout , UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setNavigationBarHeader("professionalBackground")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        var reuseIdentifierPrefix = "profissionalPage"
