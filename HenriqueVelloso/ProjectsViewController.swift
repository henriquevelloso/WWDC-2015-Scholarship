...
//  HenriqueVelloso
//
//  Created by Henrique Velloso on 4/19/15.
//
//

import UIKit

class ProjectsViewController: UIViewController , UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout , UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setNavigationBarHeader("projectsWorkedOn")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        var reuseIdentifierPrefix = "projectPage"
